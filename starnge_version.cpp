...
int  div_in_lines (char *adres[], char *Onegin, int size);
...
int main (int argc, char* argv[])
{
    ...
    char *adres[Max_row] = {};
    int am_of_lines = 0;
    am_of_lines = div_in_lines (adres, Onegin, size);
...
int div_in_lines (char *adres[], char *Onegin, int size) // Тут я надеюсь на ненулевую массив
{
